  ...
  return (
    <div className="container mx-auto px-4 py-10">
      ...
      <section className="rounded-lg p-6 md:p-10 mb-8 text-center flex flex-col items-center">
        ...
        {/* Description */}
        <p className="max-w-xl sm:max-w-2xl mb-6 text-xs sm:text-sm md:text-base">
        ...
        <div className="mt-6 flex flex-col sm:flex-row justify-center gap-4 w-full sm:w-auto">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="px-4 py-2 flex items-center gap-2 bg-white text-lg sm:text-xl font-semibold rounded shadow w-full sm:w-auto justify-center hover:opacity-90 transition"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="px-4 py-2 flex items-center gap-2 rounded text-lg sm:text-xl font-semibold bg-white/30 w-full sm:w-auto justify-center hover:opacity-90 transition"
          >
            <img src={store} alt="store" className="w-[24px] h-[24px]" />
            App Store
          </a>
        </div>
      ...
      {/* Stats */}
      <section
        className="p-12 md:p-20 w-full mb-20 text-center text-white"
        style={{
          background:
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          <div className="p-6 rounded-lg">
            ...
            <h3 className="text-4xl sm:text-5xl md:text-6xl font-extrabold">
              29.6M
            </h3>
      ...
      <section className="mb-8 text-center">
        <div className="mb-6">
          ...
          <p className="text-gray-600 mt-1 md:mt-2 max-w-2xl mx-auto text-sm sm:text-base">
        ...
        <div>
          <button
            ...
            className="text-white px-6 py-2 border rounded transition text-sm sm:text-base"
          >
            Show All
          </button>
        </div>
